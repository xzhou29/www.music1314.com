...
$sql = "SELECT  SUM(Quantity) AS totalQuantity, SUM(P_Price) AS totalValue, P_Name FROM TotalValueForProduct GROUP BY P_Name; ";

$result = $conn->query($sql);

?>  

     <div align="center"><h2>Total Values for Products</h2> 
