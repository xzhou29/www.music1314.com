...
<body class="bg-info">
	...
	<div align="center" class="row">
			<img src="uploadPictures/Performance at UH.jpg" alt="Mountain View" style="width:389px;height:291px;">
				...
				<h3> I am an undergraduate student of Computer Science at University Of Houston(UH).</h3>

				<h3> I am also working for the UH Computer Graphics and Interactive Media(CGIM) Lab.  </h3>
