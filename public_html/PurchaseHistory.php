...
$sql = "SELECT CustomerName, CUSTOMERID, OrderID, OrderDate, Quantity, SUM(P_Price) AS totalValue, P_Name FROM PurchaseHistory  GROUP BY OrderDate, OrderID DESC, P_Name, OrderDate ;";
$result = $conn->query($sql);


?>  

     <div align="center"><h2>Purchase History</h2> 

   <TABLE BORDER="1" BGCOLOR="CCFFFF" width='50%' cellspacing='1' cellpadding='0' bordercolor="black" border='1'>
            <TR>
             	<TH bgcolor='#DAA520'> <font size='2'/>Customer Name </TH>
                <TH bgcolor='#DAA520'> <font size='2'/>Customer ID </TH>
                <TH bgcolor='#DAA520'><font size='2'/>Order ID</TH>
                <TH bgcolor='#DAA520'> <font size='2'/>Order Date</TH>
                <TH bgcolor='#DAA520'> <font size='2'/>Product Name </TH>
                <TH bgcolor='#DAA520'><font size='2'/>Total Quantity</TH>
                <TH bgcolor='#DAA520'><font size='2'/>Total Value</TH>
     ...
     // output data of each row
            ...
            <TR>
               ...
               <?php  echo "<br> ". $row["CustomerName"] . "<br>"; ?>
                 </center></TD>

                <TD> <font size='2'/><center>
               <?php  echo "<br> ". $row["CUSTOMERID"] . "<br>"; ?>
                 </center></TD>

                <TD> <font size='2'/><center>
	 				<?php  echo "<br> ". $row["OrderID"] . "<br>"; ?>
                </center></TD>

                <TD> <font size='2'/><center>
               <?php  echo "<br> ". $row["OrderDate"] . "<br>"; ?>
                 </center></TD>
               ...
               <?php  echo "<br> ". $row["P_Name"] . "<br>"; ?>
                ...
                <TD> <font size='2'/><center>
                    <?php  echo "<br> ". $row["Quantity"] . "<br>"; ?>
                </center></TD>

                 <TD> <font size='2'/><center>
                    <?php  echo "<br> ". $row["totalValue"] . "<br>"; ?>
                </center></TD>
